...
import com.coding.meet.util.MediumContent
...
fun MediumDummyArticleData(): Medium? {
    ...
    LaunchedEffect(Unit) {
        try {
            val myMedium = json.decodeFromString<Medium>(MediumContent.jsonStr)
            ...
            console.error("Failed to decode dummy Medium data", e)
        }
    }
    return medium
}
